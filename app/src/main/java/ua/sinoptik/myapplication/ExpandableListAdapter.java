...
int i = 0;
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        else position = childPosition+ (groupPosition-1)*8 + MainActivity.day1.size();
        Log.d("log", "Абсолютная позиция  - " +  position);
        Picasso.with(MainActivity.context).load("http://openweathermap.org/img/w/" + listicon.get(position) + ".png").into(((ImageView) convertView.findViewById(R.id.imageView2)));
        i++;
